...
*/
jaxon.callback=jaxon.ajax.callback.create(),jaxon.request=jaxon.ajax.request.execute,jaxon.register=jaxon.ajax.handler.register,jaxon.$=jaxon.tools.dom.$,jaxon.getFormValues=jaxon.tools.form.getValues,jaxon.msg=jaxon.ajax.message,jaxon.js=jaxon.cmd.script,jaxon.isLoaded=!0,jaxon.cmd.delay.q={send:jaxon.tools.queue.create(jaxon.config.requestQueueSize),recv:jaxon.tools.queue.create(2*jaxon.config.requestQueueSize)},jaxon.command={},jaxon.command.handler={},jaxon.command.handler.register=jaxon.ajax.handler.register,jaxon.command.create=function(e,t,n){var a={cmd:"*",fullName:"* unknown command name *"};return a.sequence=e,a.request=t,a.context=n,a};var jxn={};jxn.$=jaxon.tools.dom.$,jxn.getFormValues=jaxon.tools.form.getValues,jxn.request=jaxon.request;