...
*/
jaxon.request=jaxon.ajax.request.execute,jaxon.register=jaxon.ajax.handler.register,jaxon.$=jaxon.utils.dom.$,jaxon.getFormValues=jaxon.utils.form.getValues,jaxon.msg=jaxon.ajax.message,jaxon.js=jaxon.cmd.script,jaxon.isLoaded=!0,jaxon.cmd.delay.q={send:jaxon.utils.queue.create(jaxon.config.requestQueueSize),recv:jaxon.utils.queue.create(2*jaxon.config.requestQueueSize)},jaxon.command={handler:{},handler:{register:jaxon.ajax.handler.register},create:function(e,t,n){return{cmd:"*",fullName:"* unknown command name *",sequence:e,request:t,context:n}}};const jxn={$:jaxon.utils.dom.$,getFormValues:jaxon.utils.form.getValues,request:jaxon.request};